package org.wangz.traffic.util;
...
public class ConfManagerUtils {
    ...
    static {
        try {
            ...
            InputStream in = ConfManagerUtils.class
                    .getClassLoader().getResourceAsStream("E:\\Java_Project\\TrafficMonitor\\src\\main\\resources\\my.properties");
